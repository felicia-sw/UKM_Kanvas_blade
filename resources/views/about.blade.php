    ...
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-5">
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="value-card glass-card p-4 text-center h-100" style="background: rgba(42, 10, 86, 0.7); backdrop-filter: blur(10px); border: 2px solid rgba(255, 236, 119, 0.3);">
