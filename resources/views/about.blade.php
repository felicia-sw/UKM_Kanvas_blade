        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center text-center mb-5 mt-5 pt-5">
                <div class="col-12">
                    ...
                    <p class="page-subtitle text-white fs-5 mx-auto" style="max-width: 600px;" data-aos="fade-up"
                        data-aos-delay="100">
            ...
            <div class="container py-5">
                ...
                <div class="row mb-5 align-items-center">
                    <div class="col-lg-6 mb-4 mb-lg-0" data-aos="fade-right">
                        <div class="about-image-container text-center">
                            <img src="{{ asset('images/mascot2.png') }}" alt="Kanvas mascot2"
                ...
                <div class="row g-4 mb-5">
                    <div class="col-lg-6" data-aos="fade-up">
                        <div class="glass-card p-5 h-100"
                            style="background: rgba(42, 10, 86, 0.7); backdrop-filter: blur(10px); border: 2px solid rgba(255, 236, 119, 0.3);">
                ...
                <!-- stats -->
                <div class="stats-section glass-card p-5 mb-5"
                    style="background: rgba(42, 10, 86, 0.7); backdrop-filter: blur(10px); border: 2px solid rgba(255, 236, 119, 0.3);"
                    data-aos="fade-up">
                    <div class="row text-center g-4">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="stat-item">
                                <h2 class="text-warning fw-bold display-4 mb-2">10+</h2>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="stat-item">
                                <h2 class="text-warning fw-bold display-4 mb-2">4+</h2>
                ...
                <!-- CTA  -->
                <div class="glass-card p-5 rounded-4 text-center"
                    style="background: rgba(42, 10, 86, 0.7); backdrop-filter: blur(10px); border: 2px solid rgba(255, 236, 119, 0.3);"
                    data-aos="fade-up">
