...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <h1 class="h2 mb-0">Add New Event</h1>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('location') is-invalid @enderror" id="location"
                            name="location" value="{{ old('location') }}" placeholder="e.g., Kampus A, Online">
                        @error('location')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" id="has_multiple_days" name="has_multiple_days"
                        value="1" {{ old('has_multiple_days') ? 'checked' : '' }}
                        onchange="toggleMultipleDaysPricing()">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01"
                                class="form-control @error('day_1_price') is-invalid @enderror" id="day_1_price"
                                name="day_1_price" value="{{ old('day_1_price', 0) }}">
                            @error('day_1_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01"
                                class="form-control @error('day_2_price') is-invalid @enderror" id="day_2_price"
                                name="day_2_price" value="{{ old('day_2_price', 0) }}">
                            @error('day_2_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01"
                                class="form-control @error('both_days_price') is-invalid @enderror" id="both_days_price"
                                name="both_days_price" value="{{ old('both_days_price', 0) }}">
                ...
                <div class="mb-4">
                    <label for="poster_image" class="form-label">Event Poster Image <span
                            class="text-danger">*</span></label>
                    <input type="file" class="form-control @error('poster_image') is-invalid @enderror"
                        id="poster_image" name="poster_image" required>
