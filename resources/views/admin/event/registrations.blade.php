    ...
    <div class="container-fluid py-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <a href="{{ route('admin.events.index') }}" class="btn btn-admin-outline-secondary mb-2">
                            <i class="bi bi-arrow-left me-2"></i>Back to Events
                        </a>
                        <h1 class="h3 mb-0">{{ $event->title }} - Registrations</h1>
                    </div>
                    <a href="{{ route('admin.events.finances.recap', $event->id) }}" class="btn btn-admin-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="mb-1"><strong>Max Participants:</strong> {{ $event->max_participants ?? 'Unlimited' }}
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <h2 class="mb-0">
                                    {{ $event->registrations()->where('payment_status', 'pending')->count() }}</h2>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <h2 class="mb-0 text-success">Rp {{ number_format($event->getTotalIncome(), 0, ',', '.') }}
                                </h2>
                            </div>
                            <div class="text-info">
        ...
        <div class="tab-content" id="registrationTabsContent">
            ...
            <div class="tab-pane fade show active" id="all" role="tabpanel">
                @include('admin.event.partials.registration-table', [
            ...
            <div class="tab-pane fade" id="pending" role="tabpanel">
                @include('admin.event.partials.registration-table', [
                    'registrations' => $event->registrations()->where('payment_status', 'pending')->get(),
                ])
            </div>
            ...
            <div class="tab-pane fade" id="verified" role="tabpanel">
                @include('admin.event.partials.registration-table', [
                    'registrations' => $event->registrations()->where('payment_status', 'verified')->get(),
                ])
            </div>
            ...
            <div class="tab-pane fade" id="rejected" role="tabpanel">
                @include('admin.event.partials.registration-table', [
                    'registrations' => $event->registrations()->where('payment_status', 'rejected')->get(),
                ])
            </div>
        </div>
    </div>
