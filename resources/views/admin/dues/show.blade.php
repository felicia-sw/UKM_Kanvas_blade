...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                Due Date: {{ $duesPeriod->due_date->format('d M Y') }}
            </p>
        </div>
    ...
    <div class="admin-card mb-4">
        <div class="card-body">
            <h3 class="h5 mb-3"><i class="bi bi-check-circle-fill text-success me-2"></i>Paid ({{ $paidUsers->count() }})</h3>
    ...
    <div class="admin-card mb-4">
        <div class="card-body">
            <h3 class="h5 mb-3"><i class="bi bi-clock-fill text-warning me-2"></i>Pending Verification ({{ $pendingUsers->count() }})</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($payment->payment_proof)
                                            <a href="{{ Storage::url($payment->payment_proof) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                    ...
                                    <td>
                                        <form action="{{ route('admin.dues-payments.verify', $payment->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('PATCH')
    ...
    <div class="admin-card">
        <div class="card-body">
            <h3 class="h5 mb-3"><i class="bi bi-x-circle-fill text-danger me-2"></i>Not Paid Yet ({{ $unpaidUsers->count() }})</h3>
