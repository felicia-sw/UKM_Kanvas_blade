...
<div class="container-fluid py-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.events.finances.recap', $event->id) }}">Financial Recap</a></li>
            <li class="breadcrumb-item active">Edit {{ ucfirst($incomeExpense->type) }}</li>
        </ol>
    </nav>

    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">Edit {{ ucfirst($incomeExpense->type) }}: {{ $incomeExpense->item_name }}</h1>
            ...
            <form action="{{ route('admin.events.finances.update', [$event->id, $incomeExpense->id]) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="item_name" 
                               name="item_name" 
                               value="{{ old('item_name', $incomeExpense->item_name) }}"
                               placeholder="e.g., Sponsorship, Equipment, Venue, etc."
                               required>
                        @error('item_name')
                ...
                <div class="mb-3">
                    ...
                    <input type="date" 
                           ...
                           value="{{ old('transaction_date', $incomeExpense->transaction_date->format('Y-m-d')) }}"
                           required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                              ...
                              name="description" 
                              rows="4"
                              placeholder="Add any additional details about this {{ $incomeExpense->type }}...">{{ old('description', $incomeExpense->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn {{ $incomeExpense->type === 'income' ? 'btn-success' : 'btn-danger' }}">
