                ...
                <form action="{{ route('admin.events.finances.update', [$event->id, $incomeExpense->id]) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('amount') is-invalid @enderror" id="amount"
                                name="amount" value="{{ old('amount', $incomeExpense->amount) }}" min="0"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                            rows="4" placeholder="Add any additional details about this {{ $incomeExpense->type }}...">{{ old('description', $incomeExpense->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
