    ...
    <div class="container-fluid py-4">
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <div
                                    class="avatar avatar-lg {{ $netBalance >= 0 ? 'bg-success' : 'bg-danger' }} bg-opacity-10 {{ $netBalance >= 0 ? 'text-success' : 'text-danger' }} rounded">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span
                            class="badge {{ $budgetUsage > 100 ? 'bg-danger' : ($budgetUsage > 80 ? 'bg-warning' : 'bg-success') }}">
                            {{ number_format($budgetUsage, 1) }}%
                        </span>
                    </div>
                    <div class="progress" style="height: 30px;">
                        <div class="progress-bar {{ $budgetUsage > 100 ? 'bg-danger' : ($budgetUsage > 80 ? 'bg-warning' : 'bg-success') }}"
                            role="progressbar" style="width: {{ min($budgetUsage, 100) }}%;"
                            aria-valuenow="{{ $budgetUsage }}" aria-valuemin="0" aria-valuemax="100">
                            Rp {{ number_format($totalExpenses, 0, ',', '.') }} / Rp
                    ...
                    @if ($event->isBudgetExceeded())
                        <div class="alert alert-danger mt-3 mb-0">
                            ...
                            <strong>Warning:</strong> Budget exceeded by Rp
                            {{ number_format($totalExpenses - $event->budget, 0, ',', '.') }}
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.events.finances.income.create', $event->id) }}"
                                    ...
                                    <tfoot class="table-light">
                                        <tr>
                                            ...
                                            <td class="text-end"><strong>Rp
                                                    {{ number_format($totalManualIncome, 0, ',', '.') }}</strong></td>
                                            <td></td>
                                        </tr>
                                    </tfoot>
                                </table>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="bi bi-arrow-up-circle text-danger me-2"></i>Expenses (Pengeluaran)
                        </h5>
                        <a href="{{ route('admin.events.finances.expense.create', $event->id) }}"
                                        ...
                                        @foreach ($expenses as $expense)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.events.finances.destroy', [$event->id, $expense->id]) }}"
                                                        method="POST" class="d-inline"
