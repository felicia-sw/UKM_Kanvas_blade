                ...
                <div class="bg-dark bg-opacity-50 rounded-4 p-4 p-md-5 mb-4 backdrop-blur">
                                    ...
                                    <div class="card bg-dark bg-opacity-75 border-warning">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text mb-2">
                                                <strong>Amount:</strong> Rp {{ number_format($dues->amount, 0, ',', '.') }}<br>
                                            ...
                                            @else
                                                <a href="{{ route('dues.payment.create', $dues->id) }}" class="btn btn-warning btn-sm">
                    ...
                    <div>
                        ...
                        @if($payments->count() > 0)
                                    ...
                                    <tbody>
                                        @foreach($payments as $payment)
                                            <tr>
                                                ...
                                                <td>Rp {{ number_format($payment->duesPeriod->amount, 0, ',', '.') }}</td>
                                                <td>
                                                    <span class="badge 
                            ...
                            {{ $payments->links() }}
                        @else
                            <p class="text-white-50">No payment history yet.</p>
                        @endif
                    </div>
                </div>
            </div>
